...
export const adminNav: NavSection[] = [
  ...
  },
  {
    label: 'Sales',
    items: [
      { label: 'Contacts', href: '/admin/crm/contacts', icon: Inbox, moduleKey: 'crm-leads' },
...
export const memberNav: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Contacts', href: '/team/crm/contacts', icon: Inbox, visibleTo: ['TEAM'], moduleKey: 'crm-leads' },
